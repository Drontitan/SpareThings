        ...
        <div className="newProductContainer">
          {loading ? (
            ...
            >
              <div>
                <div className="confirmshippingArea">
                  <Typography style={{"fontSize":"1.5rem"}}>Shipping Info</Typography>
                  <div className="orderDetailsContainerBox">
                    <div   >
                      <p  style={{"fontSize":"1.2rem"}}>Name:</p>
                      <span style={{"fontSize":"1rem","color":"white"}}>{order.user && order.user.name}</span>
                    </div>
                    <div>
                  ...
                  <Typography style={{"fontSize":"1.5rem"}}>Payment</Typography>
                  <div className="orderDetailsContainerBox">
                    <div>
                      <p
                        className={
                    ...
                    <div>
                      ...
                      <span style={{"fontSize":"1.2rem","color":"white"}}>{order.totalPrice && order.totalPrice}</span>
                    </div>
                  </div>

                  <Typography style={{"fontSize":"1.5rem"}}>Order Status</Typography>
                  <div className="orderDetailsContainerBox">
                    <div>
                      <p
                        className={
                ...
                <div className="confirmCartItems">
                  <Typography style={{"fontSize":"1.5rem"}}>Your Cart Items:</Typography>
                  <div className="confirmCartItemsContainer">
                    {order.orderItems &&
                      order.orderItems.map((item) => (
                        <div key={item.product}>
                          <img src={item.image} alt="Product" />
                          <Link style={{"fontSize":"1.2rem","color":"white"}} to={`/product/${item.product}`}>
                            {item.name}
                          </Link>{" "}
              ...
              >
                ...
                >
                  ...
                  <div>
                    <AccountTreeIcon />
                    <select 
                     style={{"width":"20vw","margin-left":"30vw","cursor":"pointer"}}
                  ...
                  <Button
                    id="createProductBtn"
                    type="submit"
                    style={{"width":"10vw","margin-left":"35vw","cursor":"pointer"}}
                    disabled={
                      loading ? true : false || status === "" ? true : false
                    }
                  >
